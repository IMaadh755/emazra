...
function applyTheme(theme) {
    ...
    root.style.setProperty('--glass-bg', theme.cardBackgroundColor);
...
function updateInputValues(theme) {
    ...
    document.getElementById('cardBackgroundColor').value = theme.cardBackgroundColor;
    ...
    document.getElementById('tableColor').value = theme.tableColor;
...
function updateLivePreview(theme) {
    ...
    if (preview) {
        ...
        preview.style.setProperty('--glass-bg', theme.cardBackgroundColor);
...
function setupThemeListeners() {
    ...
    document.getElementById('saveThemeBtn')?.addEventListener('click', async () => {
        const theme = {
            ...
            tableColor: inputs.tableColor.value,
            buttonColor: inputs.buttonColor.value,
            backgroundColor: inputs.backgroundColor.value,
            cardBackgroundColor: inputs.cardBackgroundColor.value,
